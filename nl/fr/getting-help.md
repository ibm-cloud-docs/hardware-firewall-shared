...
# Aide et assistance pour le pare-feu matériel (partagé)
{: #getting-help-and-support-for-hardware-firewall-shared-}

Si vous avez des problèmes ou des questions à poser concernant l'utilisation du pare-feu matériel (partagé), vous pouvez obtenir de l'aide en recherchant des informations ou en posant des questions sur l'un des forums indiqués ci-dessous. Vous pouvez également ouvrir un ticket de demande de service.
...
* Pour toute question technique sur le pare-feu matériel (partagé), publiez votre question sur [Stack Overflow](https://stackoverflow.com/search?q=hardware-firewalls+ibm-cloud) avec les balises "hardware-firewalls" et "ibm-cloud".
