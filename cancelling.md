...
4.  In the **Firewall** tab, click on the **Actions** dropdown menu and choose **Cancel Firewall**. In the next dialog, choose whether you want to cancel immediately or at the next billing cycle.
